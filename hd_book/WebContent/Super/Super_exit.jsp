		...
		<div class="row " style="margin-top: 50px;">
			<div align="center" class="col-md-3">
				<ul class="list-group">
					<c:if test="${sessionScope.usertype=='-1'}">
						...
						<li class="list-group-item  active"><a href="<%=request.getContextPath() %>/Super/Super_exit.jsp"><span
			...
			<div class="col-md-9" align="center" style="border: 1px solid black;">
				...
				<div align="center" style="padding-top: 80px; width: 250px;"
					...
					<a href="<%=request.getContextPath() %>/Super/Super_about.jsp" class="btn btn-info " style="width: 80px">取消</a>
				</div>
			</div>
		</div>
	</div>
