						...
						<table align="center">
							<tr>
							  ...
							  <tr>
								...
								<td>
									<input type="radio" name="sex" value="男" style="margin-left: 50px; margin-top: 10px;" <c:if test="${user.sex == '男'}">checked</c:if>>男
									<input type="radio" name="sex" value="女" style="margin-left: 50px; margin-top: 10px;" <c:if test="${user.sex == '女'}">checked</c:if>>女
								</td>
							  </tr>
							  <tr>
								...
								<td><input type="text" name="password" 
									style="margin-left: 50px; margin-top: 10px;"
									class="form-control inputclass" value ="${user.passwords}"></td>
							  </tr>
							  <tr>
								<td align="center"><b>生日</b></td>
								<td><input type="text" name="birthday" value = "${user.birthday }"
								style="margin-left: 50px; margin-top: 10px;"
							  ...
							  <tr>
								...
								<select name="usertype" style="margin-left: 50px; margin-top: 10px;">
										<option value = "0" <c:if test="${user.usertype == 0}">selected</c:if>>图书管理员</option>
										<option value = "1" <c:if test="${user.usertype == 1}">selected</c:if> >读者</option>
										<option value = "-1" <c:if test="${user.usertype == -1}">selected</c:if>>系统管理员</option>
									</select>		
								</td>
							  </tr>
